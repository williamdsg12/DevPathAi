...
export default function CodeLabPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="Editor de código no navegador com visualização em tempo real e análise de qualidade por IA"
    >
      <div className="space-y-6 pb-16">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-3xl border border-white/10 bg-[#12111d] p-4 shadow-xl">
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            >
              <Play className="size-4 fill-white" /> Executar (Run)
            </Button>
        ...
        <div className="grid gap-6 lg:grid-cols-2 items-stretch">
          ...
          <div className="space-y-4 flex flex-col">
            ...
            <Card className="border-white/10 bg-black/90 text-emerald-400 font-mono text-xs shadow-xl rounded-2xl">
              ...
              <CardContent className="p-3.5 max-h-36 overflow-y-auto space-y-1 scrollbar-thin">
