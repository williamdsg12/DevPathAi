...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Trilha personalizada com IA</span> <span className="text-primary/60">✦</span>
    <span>Progresso diário acompanhado</span> <span className="text-secondary/60">✦</span>
    <span>DevMentor 24/7</span> <span className="text-primary/60">✦</span>
    <span>Projetos reais para portfólio</span> <span className="text-secondary/60">✦</span>
    <span>Do zero à carreira</span> <span className="text-primary/60">✦</span>
  </div>
);
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            <h2
              ref={headingRef}
              className="text-5xl md:text-8xl font-black footer-text-glow tracking-tighter mb-12 text-center text-balance"
            >
              Pronto para começar?
            </h2>
