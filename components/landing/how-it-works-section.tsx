      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-16 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {steps.map((s) => (
            <Card
              key={s.num}
              className="relative overflow-hidden rounded-3xl border border-white/5 bg-[#12111a] hover:border-violet-500/30 transition-all duration-300 group shadow-lg"
            >
              <CardHeader className="p-6 sm:p-7 space-y-4">
                ...
                <div className="space-y-1.5">
                  <Badge variant="outline" className="text-[10px] uppercase font-bold tracking-wider text-violet-400 border-violet-500/20 bg-violet-950/20">
                    {s.badge}
                  </Badge>
